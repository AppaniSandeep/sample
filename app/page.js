      ...
      <div className='flex h-screen'>
        ...
        <div className='flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <p className='text-2xl font-medium'>Hi, I'm ChatGpt.</p>
          </div>
          <p className='text-sm mt-2'>How can I help you today?</p></>) : (
            <div ref={containerRef} className='relative flex flex-col items-center justify-start w-full mt-20 max-h-screen overflow-y-auto'>
              <p className='fixed top-8 border border-transparent hover:border-gray-500/50 py-1 px-2 rounded font-semibold mb-6'>{selectedChat.name}</p>
          ...
          <p className='text-xs absolute bottom-1 text-gray-500'>AI-genereted, for reference only</p>
        </div>
      </div>
    </div>
  );
}
// This is the main page of the DeepSeek application, which includes a sidebar and a prompt box for user interaction.